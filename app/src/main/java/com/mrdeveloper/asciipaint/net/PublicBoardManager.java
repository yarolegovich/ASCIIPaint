package com.mrdeveloper.asciipaint.net;
...
import com.mrdeveloper.asciipaint.draw.action.BatchedChange;
...
public class PublicBoardManager {
    ...
    public Subscription<List<DrawBoard>> getBoards(Callback<List<DrawBoard>> callback) {
        ...
        final DatabaseReference boards = database.getReference(PATH_BOARDS);
