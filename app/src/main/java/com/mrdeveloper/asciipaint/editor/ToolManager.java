...
import com.mrdeveloper.asciipaint.draw.tool.BrushTool;
import com.mrdeveloper.asciipaint.draw.tool.EraserTool;
...
public class ToolManager {
    ...
    public ToolManager(Context context, ASCIICanvas canvas, Bundle savedInstanceState) {
        DEFAULT_SYMBOL = context.getString(R.string.default_draw_symbol).charAt(0);
