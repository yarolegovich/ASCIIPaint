...
public class BoardListFabBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {

    private int fabCenterRestY;
    private int fabHalfWidth;

    public BoardListFabBehavior() {
    }

    public BoardListFabBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
