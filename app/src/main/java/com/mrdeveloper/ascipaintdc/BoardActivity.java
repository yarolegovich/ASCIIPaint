...
import com.mrdeveloper.ascipaintdc.data.ShareManager;
import com.mrdeveloper.ascipaintdc.draw.MemoizingCanvas;
...
import com.mrdeveloper.ascipaintdc.draw.tool.PresetImageTool;
import com.mrdeveloper.ascipaintdc.draw.PresetImages;
import com.mrdeveloper.ascipaintdc.draw.tool.Tool;
import com.mrdeveloper.ascipaintdc.editor.BoardManager;
import com.mrdeveloper.ascipaintdc.editor.PresetImageDropMode;
import com.mrdeveloper.ascipaintdc.editor.PresetPicker;
import com.mrdeveloper.ascipaintdc.editor.SizePickerDialog;
import com.mrdeveloper.ascipaintdc.editor.SymbolPickerDialog;
import com.mrdeveloper.ascipaintdc.editor.ToolManager;
import com.mrdeveloper.ascipaintdc.view.ASCIIPaintView;
import com.mrdeveloper.ascipaintdc.view.ColorCircleView;
import com.mrdeveloper.ascipaintdc.view.TintableIconTextView;
import com.mrdeveloper.ascipaintdc.view.TintableMenuItem;
...
public class BoardActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    /*
     * TODO: Implement brush tool
     * TODO: Add image sharing
     * TODO: Add preset scale and rotation
     * TODO: Move presets to xml
     * TODO: Add eyes preset
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawBoard drawBoard = (DrawBoard) getIntent().getSerializableExtra(EXTRA_BOARD);
        drawBoard.setCanvas(paintView.getCanvas());
        paintView.setCanvas(canvas);
        canvas.setListener(this);

        boardManager = new BoardManager(drawBoard);
    ...
    public void onColorPicked(int color) {
        ...
        if (currentTool instanceof PresetImageTool) {
            ...
            ((PresetImageTool) currentTool).drawAtLastLocation();
            canvas.drawToScreen();
        }
        updateTools();
    }
